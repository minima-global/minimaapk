...
//
    ...
    public void installMiniDAPPs(){
        ...
        if(!pref.getBoolean(minidapppref,false)){
            ...
            new InstallAssetMiniDAPP("chatter-3.0.mds.zip", MainActivity.this).run();
            ...
            new InstallAssetMiniDAPP("maxsolo-2.3.2.mds.zip", MainActivity.this).run();
            ...
            new InstallAssetMiniDAPP("wallet_2.12.0.mds.zip", MainActivity.this).run();
