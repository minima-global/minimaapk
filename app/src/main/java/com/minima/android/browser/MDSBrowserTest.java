    ...
    private void loadBasePage(){
        String summary =
                "<html><body>" +
                        ...
                        "<br><br>" +
                        "<input type=\"button\" value=\"Prompt\" onClick=\"var tt = prompt('Hello','you');console.log(tt);\" />\n" +
                        "<br><br>" +
                        "<input type=\"button\" value=\"Disable Context\" onClick=\"Android.disableDefaultContextMenu();\" />\n" +
                        "<br><br>" +
